...
|
*/
$config['rest_realm'] = 'PopRx REST API';
...
// method name on which no api key check
 $config['auth_override_class_method']['heartbeat']['index'] = 'none';
 $config['auth_override_class_method']['heartbeat']['update_temp_data'] = 'none';
 
 $config['auth_override_class_method']['user']['signup'] = 'none';
 $config['auth_override_class_method']['user']['signin'] = 'none';
 $config['auth_override_class_method']['user']['forgotpassword'] = 'none';
 $config['auth_override_class_method']['user']['anonymous_footer'] = 'none';
 $config['auth_override_class_method']['user']['anonymous_pharmacist_connect'] = 'none';
 
 $config['auth_override_class_method']['pharmacy']['signin'] = 'none';
 $config['auth_override_class_method']['pharmacy']['forgotpassword'] = 'none';
 
 $config['auth_override_class_method']['admin']['signin'] = 'none';
 $config['auth_override_class_method']['upload']['*'] = 'none';
 $config['auth_override_class_method']['allergy']['master_list'] = 'none'; 
...
|
*/
$config['rest_key_column'] = 'KeyGUID';
...
|
*/
$config['rest_key_name'] = 'login_session_key';
