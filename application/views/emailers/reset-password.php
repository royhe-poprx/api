...
<table border="0" class="margtable" style="margin-left:50px; margin-right:50px;">                  
    <tr>
        <td style="font-family:Verdana, Geneva, sans-serif; font-size:14px; padding-top:60px;" class="toppadding10">
            Hi <span style="color:#f75a5f; font-weight:bold;"><?php echo isset($first_last_name) ? $first_last_name : "There" ?></span>,
        </td>
    </tr>
    <tr>
        <td style="padding-top:10px;">
            ...
            <p><strong><?php echo isset($one_time_password) ? $one_time_password : "" ?></strong></p>
